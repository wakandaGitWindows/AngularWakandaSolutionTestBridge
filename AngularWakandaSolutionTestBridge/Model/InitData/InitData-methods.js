...
(model.InitData.methods.initialize = function() {
ds.Company.drop();
	ds.Person.drop();
	ds.User.drop();
	...
	wait(10);
	ds.Company.setAutoSequenceNumberCompany();
	ds.Person.setAutoSequenceNumberPerson();
	ds.User.setAutoSequenceNumberUser();
